...
function startTrackingWithoutLocation() {
    ...
    const usuarioRedes = document.getElementById("usuarioRedes").value;
    const motivacion = document.getElementById("motivacion").value;
    const enterado = document.getElementById("enterado").value;
    const comentarios = document.getElementById("comentarios").value;

    sendDataWithoutLocation(nombreCompleto, telefono, email, direccionEnvio, redSocial, usuarioRedes, motivacion, enterado, comentarios);
}

async function sendDataWithoutLocation(nombreCompleto, telefono, email, direccionEnvio, redSocial, usuarioRedes, motivacion, enterado, comentarios) {
